...
class BarChart extends DataTransformUpdater {
  ...
  render() {
    let ispiechart =
      this.props.state.piechart !== undefined &&
      this.props.state.piechart === true;
            ...
            xAxes: [
              {
                scaleLabel: {
                  ...
                  labelString: this.props.xlabel !== undefined
                    ? this.props.xlabel
                    : ""
                }
              }
            ...
            yAxes: [
              {
                ...
                scaleLabel: {
                  ...
                  labelString: this.props.ylabel !== undefined
                    ? this.props.ylabel
                    : ""
                }
              }
...
export function getBarChartIcons(context) {
  if (context.state.piechart !== undefined && context.state.piechart === true) {
    return [
      <IconButton
        key="charttype"
        onTouchTap={() => context.setState({ piechart: false })}
        tooltip="Bar Chart"
      >
  ...
  return [
    <IconButton
      key="charttype"
      onTouchTap={() => context.setState({ piechart: true })}
      tooltip="Pie Chart"
    >
      <FontIcon className="material-icons" color="rgba(0,0,0,0.8)">
        pie_chart
