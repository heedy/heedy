        ...
        >
          {this.props.links.map(link =>
            <ListItem
              ...
              value={link.page}
              leftIcon={
                <FontIcon className="material-icons" style={{ color: "black" }}>
                  {" "}{link.icon}{" "}
                </FontIcon>
              }
              innerDivStyle={styles.menuInnerDivStyle}
...
export default connect(
  state => ({ links: state.site.navigation }),
  dispatch => ({
