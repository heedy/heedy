    ...
    return (
      ...
      >
        ...
        <EmailEditor
          ...
          value={edits.email !== undefined ? edits.email : user.email}
          onChange={this.props.callbacks.emailChange}
        />
        <br />
        <PublicEditor
          public={edits.public !== undefined ? edits.public : user.public}
          type="user"
          onChange={this.props.callbacks.publicChange}
        />
        <RoleEditor
          roles={this.props.roles}
          role={edits.role !== undefined ? edits.role : user.role}
          type="user"
        ...
        <TextField
          ...
          value={edits.password !== undefined ? edits.password : ""}
        ...
        {edits.password !== undefined
          ? <TextField
              ...
              value={edits.password2 !== undefined ? edits.password2 : ""}
...
export default connect(
  store => ({ roles: store.site.roles.user }),
  (dispatch, props) => ({
    callbacks: {
      ...
      passwordChange: (e, txt) =>
        dispatch({
          type: "USER_EDIT",
          name: props.user.name,
          value: { password: txt }
        }),
      password2Change: (e, txt) =>
        dispatch({
          type: "USER_EDIT",
          name: props.user.name,
          value: { password2: txt }
    ...
    onSave: () =>
      dispatch(saveObject("user", props.user.name, props.user, props.state)),
