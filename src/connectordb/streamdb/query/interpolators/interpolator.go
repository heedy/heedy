...
//a StreamDataRange and a string array of arguments passed by the user
...
type InterpolatorGenerator func(dr datastream.StreamDataRange, args []string) (Interpolator, error)
...
//it takes
func GetInterpolator(dr datastream.StreamDataRange, interp string) (Interpolator, error) {
	if interp == "" {
