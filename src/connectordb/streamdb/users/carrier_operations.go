...
func (userdb *SqlUserDatabase) CreatePhoneCarrier(Name, EmailDomain string) (error) {
...
func (userdb *SqlUserDatabase) ReadPhoneCarrierById(Id int64) (*PhoneCarrier, error) {
	var pc PhoneCarrier
...
// ReadPhoneCarrierById selects a phone carrier from the database given its ID
func (userdb *SqlUserDatabase) ReadPhoneCarrierByName(name string) (*PhoneCarrier, error) {
	var pc PhoneCarrier
...
func (userdb *SqlUserDatabase) ReadAllPhoneCarriers() ([]PhoneCarrier, error) {
...
// struct provided.
func (userdb *SqlUserDatabase) UpdatePhoneCarrier(carrier *PhoneCarrier) error {
	if carrier == nil {
...
func (userdb *SqlUserDatabase) DeletePhoneCarrier(carrierId int64) error {
